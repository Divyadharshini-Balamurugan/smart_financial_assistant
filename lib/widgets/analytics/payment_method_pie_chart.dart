// lib/widgets/analytics/payment_method_pie_chart.dart
import 'package:flutter/material.dart';
import 'package:fl_chart/fl_chart.dart';
import 'dart:math' as math;
import 'package:intl/intl.dart';

/// Payment method pie — same behaviour/UX as CategoryPieCard but named for clarity.
class PaymentMethodPieCard extends StatelessWidget {
  final Map<String, double> paymentTotals;
  final String title;
  final bool showTitle;
  final double groupThresholdPercent;

  const PaymentMethodPieCard({
    super.key,
    required this.paymentTotals,
    this.title = 'Payment Method Chart',
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(builder: (context, constraints) {
      ...
      final processed = _groupSmallSlices(Map<String, double>.from(paymentTotals), groupThresholdPercent);
...
/// --- The following _EnhancedPie and _LegendList are identical to your category file.
/// You can keep them duplicated for now, or move both widgets to a shared file so
/// category and payment widgets reuse them. I left them here verbatim for plug-and-play.
